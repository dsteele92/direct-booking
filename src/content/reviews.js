export const reviews = [
	...
	{ 4: { name: 'April', review: 'Brenson was very helpful and kind.' } },
	{
		5: {
			name: 'Mick',
	...
	{ 8: { name: 'Laura', review: 'The hosts were very gracious and the homes was clean and beautiful.' } },
	{
		9: {
			name: 'Clayton',
	...
	{ 11: { name: 'Nancy', review: 'Great location next to Mt. Tabor Park. Host Brenson is kind and helpful!' } },
	{
		12: {
			name: 'Emily',
...
export const highlightedReviews = [
	['Christina', 'Brenson’s place is absolutely PERFECT!'],
	['Ann', 'Fabulous place near Mt Tabor park.'],
];
